...
public class GeetestLib {
     ...
     * @param newFailback the new failback
     */
     ...
     *
     * @return 閸掓繂顫愰崠鏍波閺嬶拷 response str
     */
     ...
     *
     * @param data the data
     * @return 1鐞涖劎銇氶崚婵嗩潗閸栨牗鍨氶崝锟� 閿涳拷0鐞涖劎銇氶崚婵嗩潗閸栨牕銇戠拹锟�
     */
     ...
     * @param data      the data
     * @return 妤犲矁鐦夌紒鎾寸亯, 1鐞涖劎銇氭宀冪槈閹存劕濮�0鐞涖劎銇氭宀冪槈婢惰精瑙� int
     */
    ...
    /**
     * Check result by private boolean.
     *
     * @param challenge the challenge
     * @param validate  the validate
     * @return the boolean
